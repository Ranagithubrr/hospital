    ...
    return (
        <div className="w-screen h-screen flex bg-slate-100">
            <div className="w-1/3 m-auto shadow-md rounded bg-white p-5">
                ...
                <span className='block font-bold text-black text-center my-3 pb-2'>Log In</span>
                <div className='w-3/5 m-auto py-2'>
                    ...
                    <span className='font-bold text-blue-900 text-sm cursor-pointer'>Forgot Password</span>
                    <button className="bg-blue-700 text-white block rounded px-5 py-1 w-full my-4 hover:bg-blue-600">Log In</button>
                    <span className='text-sm font-semibold text-gray-500'>Don't have an account ? <Link to="/register" className='font-bold text-blue-700 text-sm'>Sign Up</Link></span>
                </div>
            </div>
        </div>
    );
